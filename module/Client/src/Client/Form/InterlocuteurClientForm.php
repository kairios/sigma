 ...
 * @Last Modified time: 2015-06-22 16:16:03
 */

namespace Client\Form;

use Zend\Form\Form;
use Client\Model\InterlocuteurClientModel;
use Zend\I18n\Translator\Translator;

class InterlocuteurClientForm extends Form
{
	public $fields;
	...
	public function __construct($translator,$sm,$em=null,$request=null,$interlocuteur=null)
	{
		...
		$interlocuteurModel=new InterlocuteurClientModel;
