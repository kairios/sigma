...
class SaisieHeureModel implements InputFilterAwareInterface
{
	protected $inputFilter;

	public $fields=array(
		'id_saisie_projet'			=>array('type'=>'int',				'form'=>array('type'=>'hidden','label'=>'','getter'=>'Id')),
		'ref_saisie_horaire'		=>array('type'=>'int',				'form'=>array('type'=>'hidden','label'=>'','getter'=>'RefSaisieHoraire')),
		...
		'date'						=>array('type'=>'text','max'=>15,	'form'=>array('type'=>'text','required'=>false,'label'=>'Date')),
