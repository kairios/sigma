...
class InterlocuteurFournisseur
{
     ...
     * @var string
     *
     * @ORM\Column(name="complement", type="string", length=150, precision=0, scale=0, nullable=true, unique=false)
     */
    private $complement;
     ...
     *
     * @param \Fournisseur\Entity\Fournisseur $refSocieteFournisseur
     * @return InterlocuteurFournisseur
     */
    public function setRefSocieteFournisseur(\Fournisseur\Entity\Fournisseur $refSocieteFournisseur = null)
    {
