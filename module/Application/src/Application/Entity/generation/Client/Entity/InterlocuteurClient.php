...
class InterlocuteurClient
{
     ...
     * @var boolean
     *
     * @ORM\Column(name="accepte_infos", type="boolean", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     *
     * @param \Client\Entity\Client $refSocieteClient
     * @return InterlocuteurClient
     */
    public function setRefSocieteClient(\Client\Entity\Client $refSocieteClient = null)
    {
