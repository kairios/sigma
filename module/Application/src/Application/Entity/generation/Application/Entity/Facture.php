...
class Facture
{
     ...
     * @var integer
     *
     * @ORM\Column(name="ref_affaire", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $refAffaire;
     ...
     * @var integer
     *
     * @ORM\Column(name="ref_client", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $refClient;
     ...
     * @var integer
     *
     * @ORM\Column(name="ref_interlocuteur", type="integer", precision=0, scale=0, nullable=true, unique=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="ref_personnel", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     *
     * @param integer $refInterlocuteur
     * @return Facture
     */
    public function setRefInterlocuteur($refInterlocuteur)
    {
     ...
     * Set refPersonnel
     *
     * @param integer $refPersonnel
     * @return Facture
     */
    public function setRefPersonnel($refPersonnel)
    {
